#
#  Be sure to run `pod spec lint SwiftMKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "cdts_change" => "cdts_change@aliyun.com" }
  # Or just: s.author    = "cdts_change"
  # s.authors            = { "cdts_change" => "cdts_change@aliyun.com" }
  # s.social_media_url   = "http://twitter.com/wei.mao"
  ...
  s.resources = "SwiftMKit/Data/Log/*.{xcdatamodeld, xcdatamodel}"

...
public extension UIViewController {
    ...
    public func showTip(tip: String,hideAfterDelay: NSTimeInterval = NSTimeInterval(2), completion : () -> Void = {}) {
    ...
    public func showTip(tip: String, view: UIView, offset: CGPoint = CGPointZero,hideAfterDelay: NSTimeInterval = NSTimeInterval(2), completion : () -> Void = {}) {

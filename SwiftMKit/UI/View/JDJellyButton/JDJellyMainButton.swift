...
class JDJellyMainButton:JDJellyButtonView
{
    ...
    func setExpandType(_ type:JellyButtonExpandType)
    {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        LastPoint = touches.first?.location(in: self.jdRootView!)
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        let nowPoint:CGPoint = (touches.first?.location(in: self.jdRootView!))!
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        self.delegate?.MainButtonHasBeenTap(touch: touch)
    }
}

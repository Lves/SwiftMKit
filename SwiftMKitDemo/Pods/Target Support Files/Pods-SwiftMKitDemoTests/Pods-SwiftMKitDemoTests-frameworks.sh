...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-SwiftMKitDemoTests/MBProgressHUD.framework"
  install_framework "Pods-SwiftMKitDemoTests/MJExtension.framework"
  ...
  install_framework "Pods-SwiftMKitDemoTests/PulsingHalo.framework"

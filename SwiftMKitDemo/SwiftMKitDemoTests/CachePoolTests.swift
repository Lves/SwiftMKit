...
//    func testClear() {
//        let result = cachePool!.addCache("哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈哈啊哈".dataUsingEncoding(NSUTF8StringEncoding)!, name: nil)
//        NSThread.sleepForTimeInterval(1)
//        assert(result.length > 0, "缓存文件失败！")
//    }

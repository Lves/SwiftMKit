...
class MKDataNetworkRequestViewController: BaseListViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    struct InnerConst {
        ...
        static let ApiUrl = "http://apis.baidu.com/baidunuomi/openapi/cities"
    ...
    override func refreshData() {
        super.refreshData()
        let request = NSMutableURLRequest(URL: NSURL(string: InnerConst.ApiUrl)!)
        request.HTTPMethod = "GET"
        request.setValue(InnerConst.ApiKey, forHTTPHeaderField: "apikey")
